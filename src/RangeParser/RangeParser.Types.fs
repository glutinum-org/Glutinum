...
type [<AllowNullLiteral>] IExports =
    ...
    /// </summary>
    [<Emit("$0($1...)")>]
    abstract Invoke: size: int * str: string * ?options: Options -> ParseRangeResult
    [<Emit("$0($1,$2, { combine : $3 })")>]
    abstract Invoke: size: int * str: string * combine : bool -> ParseRangeResult
