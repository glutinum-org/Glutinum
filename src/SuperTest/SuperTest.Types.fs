...
module Supertest =
    ...
    type [<AllowNullLiteral>] Response =
        inherit SuperAgent.Types.Request.Response

    type [<AllowNullLiteral>] Request =
        inherit SuperAgent.Types.Request.SuperAgentRequest
    ...
    type [<AllowNullLiteral>] Test =
        ...
        abstract expect: status: float * ?callback: CallbackHandler -> Test
        abstract expect: status: float * body: obj option * ?callback: CallbackHandler -> Test
    ...
    type [<AllowNullLiteral>] SuperTest<'T when 'T :> SuperAgent.Types.Request.SuperAgentRequest> =
        inherit SuperAgent.Types.Request.SuperAgent<'T>
