namespace rec ExpressServeStaticCore.Types
...
type RangeParserRanges = Range_parser.Ranges
...
type RequestHandler =
    RequestHandler<ParamsDictionary, obj option, obj option, ParsedQs, Record<string, obj option>>

type RequestHandler<'P> =
    RequestHandler<'P, obj option, obj option, ParsedQs, Record<string, obj option>>

type RequestHandler<'P, 'ResBody> =
    RequestHandler<'P, 'ResBody, obj option, ParsedQs, Record<string, obj option>>

type RequestHandler<'P, 'ResBody, 'ReqBody> =
    RequestHandler<'P, 'ResBody, 'ReqBody, ParsedQs, Record<string, obj option>>

type RequestHandler<'P, 'ResBody, 'ReqBody, 'ReqQuery> =
    RequestHandler<'P, 'ResBody, 'ReqBody, 'ReqQuery, Record<string, obj option>>

type [<AllowNullLiteral>] RequestHandler<'P, 'ResBody, 'ReqBody, 'ReqQuery, 'Locals when 'Locals :> Record<string, obj option>> =
...
type ErrorRequestHandler =
    ErrorRequestHandler<ParamsDictionary, obj option, obj option, ParsedQs, Record<string, obj option>>

type ErrorRequestHandler<'P> =
    ErrorRequestHandler<'P, obj option, obj option, ParsedQs, Record<string, obj option>>

type ErrorRequestHandler<'P, 'ResBody> =
    ErrorRequestHandler<'P, 'ResBody, obj option, ParsedQs, Record<string, obj option>>

type ErrorRequestHandler<'P, 'ResBody, 'ReqBody> =
    ErrorRequestHandler<'P, 'ResBody, 'ReqBody, ParsedQs, Record<string, obj option>>

type ErrorRequestHandler<'P, 'ResBody, 'ReqBody, 'ReqQuery> =
    ErrorRequestHandler<'P, 'ResBody, 'ReqBody, 'ReqQuery, Record<string, obj option>>

type [<AllowNullLiteral>] ErrorRequestHandler<'P, 'ResBody, 'ReqBody, 'ReqQuery, 'Locals when 'Locals :> Record<string, obj option>> =
    [<Emit "$0($1...)">] abstract Invoke: err: obj option * req: Request<'P, 'ResBody, 'ReqBody, 'ReqQuery, 'Locals> * res: Response<'ResBody, 'Locals> * next: NextFunction -> unit

type PathParams =
    U3<string, RegExp, Array<U2<string, RegExp>>>

type RequestHandlerParams =
    RequestHandlerParams<ParamsDictionary, obj option, obj option, ParsedQs, Record<string, obj option>>

type RequestHandlerParams<'P> =
    RequestHandlerParams<'P, obj option, obj option, ParsedQs, Record<string, obj option>>

type RequestHandlerParams<'P, 'ResBody> =
    RequestHandlerParams<'P, 'ResBody, obj option, ParsedQs, Record<string, obj option>>

type RequestHandlerParams<'P, 'ResBody, 'ReqBody> =
    RequestHandlerParams<'P, 'ResBody, 'ReqBody, ParsedQs, Record<string, obj option>>

type RequestHandlerParams<'P, 'ResBody, 'ReqBody, 'ReqQuery> =
    RequestHandlerParams<'P, 'ResBody, 'ReqBody, 'ReqQuery, Record<string, obj option>>

type RequestHandlerParams<'P, 'ResBody, 'ReqBody, 'ReqQuery, 'Locals when 'Locals :> Record<string, obj option>> =
...
type [<AllowNullLiteral>] IRouterMatcher<'T, 'Method> =
    [<Emit "$0($1...)">] abstract Invoke: path: PathParams * [<ParamArray>] handlers: Array<RequestHandler<P, ResBody, ReqBody, ReqQuery, Locals>> -> 'T
    [<Emit "$0($1...)">] abstract Invoke: path: PathParams * [<ParamArray>] handlers: Array<RequestHandlerParams<P, ResBody, ReqBody, ReqQuery, Locals>> -> 'T
...
type [<AllowNullLiteral>] IRouterHandler<'T> =
    ...
    [<Emit "$0($1...)">] abstract Invoke: [<ParamArray>] handlers: Array<RequestHandler<P, ResBody, ReqBody, ReqQuery, Locals>> -> 'T
    [<Emit "$0($1...)">] abstract Invoke: [<ParamArray>] handlers: Array<RequestHandlerParams<P, ResBody, ReqBody, ReqQuery, Locals>> -> 'T
...
type Request =
    Request<ParamsDictionary, obj option, obj option, ParsedQs, Record<string, obj option>>

type Request<'P> =
    Request<'P, obj option, obj option, ParsedQs, Record<string, obj option>>

type Request<'P, 'ResBody> =
    Request<'P, 'ResBody, obj option, ParsedQs, Record<string, obj option>>

type Request<'P, 'ResBody, 'ReqBody> =
    Request<'P, 'ResBody, 'ReqBody, ParsedQs, Record<string, obj option>>

type Request<'P, 'ResBody, 'ReqBody, 'ReqQuery> =
    Request<'P, 'ResBody, 'ReqBody, 'ReqQuery, Record<string, obj option>>

type [<AllowNullLiteral>] Request<'P, 'ResBody, 'ReqBody, 'ReqQuery, 'Locals when 'Locals :> Record<string, obj option>> =
...
type Send =
    Send<obj option, Response<ResBody>>
...
type Response =
    Response<obj option, Record<string, obj option>, float>

type Response<'ResBody> =
    Response<'ResBody, Record<string, obj option>, float>

type Response<'ResBody, 'Locals when 'Locals :> Record<string, obj option>> =
    Response<'ResBody, 'Locals, float>

type [<AllowNullLiteral>] Response<'ResBody, 'Locals, 'StatusCode when 'Locals :> Record<string, obj option>> =
